...
const userGuideSections = [
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <h3>Gameplay &amp; Scoring</h3>
        <ul>
          <li>All players answer the same questions in the same order in real time</li>
          <li>Each correct answer earns <strong>100 points</strong></li>
          <li>If the host enabled <strong>Speed Bonus</strong>, faster correct answers earn up to <strong>50 bonus points</strong> — the quicker you answer, the higher the bonus</li>
          <li>A live scoreboard updates after each question so you can see standings</li>
          <li>After the final question, a results screen shows the winner and full rankings</li>
        </ul>
      </div>
    )
  },
  ...
  },
  {
    ...
    searchText: 'admin super admin promote demote user management roles toggle users search filter ai approve reject generation requests',
    content: (
      <div>
        ...
        <h3>AI Generation Requests</h3>
        <p>Admins review and approve AI question generation requests submitted by commissioners:</p>
        <ul>
          <li>Pending requests appear in the <strong>AI Requests</strong> section of the Admin Dashboard</li>
          <li>Each request shows the commissioner name, theme, difficulty, question count, and any special instructions</li>
          <li><strong>Approve</strong> — triggers the AI to generate questions automatically via an Edge Function</li>
          <li><strong>Reject</strong> — optionally include notes explaining why (visible to the commissioner)</li>
        </ul>
      </div>
    )
  },
...
const commissionerSections = [
  {
    ...
    content: (
      <div>
        ...
        <p>The dashboard has seven tabs: <strong>Overview · Announcements · Questions · AI Generate · Members · Settings · Analytics</strong></p>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    tab: 'Commissioner Guide',
    title: 'Questions Tab',
    searchText: 'questions tab manage search filter category difficulty source ai manual csv view add edit delete question bank',
    content: (
      <div>
        ...
        <ul>
          ...
          <li><strong>Source filter</strong> — filter by how questions were added: All, Manual, CSV Import, or AI Generated</li>
        </ul>
        <p>All filters combine. The count of matching questions updates in real time.</p>
        <h3>Question Badges</h3>
        <p>Question cards display badges indicating their origin:</p>
        <ul>
          <li><strong>Imported</strong> — added via CSV bulk upload</li>
          <li><strong>AI</strong> (purple) — generated by AI and imported from a generation request</li>
          <li><strong>Version badge</strong> — shows the current version number if the question has been edited</li>
        </ul>
  ...
  },
  {
    ...
    searchText: 'ai artificial intelligence generate questions claude theme auto create bulk review accept reject request approval',
    content: (
      <div>
        <p>Commissioners can request AI-generated trivia questions based on a theme. The AI (powered by Claude) creates high-quality questions that you review before adding to your question bank.</p>
        <h3>Submitting a Request</h3>
        <ol>
          <li>Go to the <strong>AI Generate</strong> tab in the Commissioner Dashboard</li>
          <li>Enter a <strong>Theme</strong> (e.g. &quot;90s Pop Culture&quot;, &quot;World War II&quot;, &quot;Space Exploration&quot;)</li>
          <li>Choose a <strong>Difficulty</strong> — Easy, Medium, Hard, or Mixed</li>
          <li>Set <strong>Question Count</strong> (how many questions to generate)</li>
          <li>Optionally add <strong>Special Instructions</strong> for the AI (e.g. &quot;focus on lesser-known facts&quot;)</li>
          <li>Click <strong>Submit Request</strong></li>
        </ol>
        <p>Your request enters a queue and must be approved by a platform admin before generation begins.</p>
        <h3>Request Lifecycle</h3>
        <table>
          <thead><tr><th>Status</th><th>What it means</th></tr></thead>
          <tbody>
            <tr><td>Pending</td><td>Waiting for admin review</td></tr>
            <tr><td>Approved</td><td>Admin approved — AI generation starts automatically</td></tr>
            <tr><td>Generating</td><td>AI is actively creating your questions</td></tr>
            <tr><td>Completed</td><td>Questions ready for your review</td></tr>
            <tr><td>Rejected</td><td>Admin declined the request (with notes explaining why)</td></tr>
          </tbody>
        </table>
        <h3>Reviewing Generated Questions</h3>
        <ol>
          <li>Once status is <strong>Completed</strong>, click <strong>Review Questions</strong> on the request card</li>
          <li>All generated questions appear with checkboxes — <strong>all are selected by default</strong> (accept-all)</li>
          <li>Uncheck any questions you don&apos;t want to import</li>
          <li>Use <strong>Select All / Deselect All</strong> to quickly toggle the entire batch</li>
          <li>Click <strong>Add Selected to Question Bank</strong> to import the checked questions</li>
        </ol>
        <p>Imported questions are automatically tagged <strong>&quot;ai-generated&quot;</strong> and show a purple <strong>AI</strong> badge in the Questions tab. You can filter by source (Manual, CSV Import, AI Generated) using the source filter chips.</p>
      </div>
    )
  },
];
...
const faqSections = [
  {
    ...
    searchText: 'faq frequently asked questions help common problems password leaderboard invite code achievement hint quiz source stats commissioner profile multiplayer room marketplace announcements timer admin ai generate artificial intelligence speed bonus scoring',
    content: (
      <div>
        ...
        <p className="faq-q">How do I generate questions with AI?</p>
        <p className="faq-a">In the Commissioner Dashboard, go to the <strong>AI Generate</strong> tab. Enter a theme, choose difficulty and count, and click <strong>Submit Request</strong>. A platform admin must approve the request, then AI generates your questions automatically. Once complete, click <strong>Review Questions</strong> — all questions are pre-selected. Uncheck any you don&apos;t want, then click <strong>Add Selected to Question Bank</strong>.</p>

        <p className="faq-q">Why is my AI generation request still pending?</p>
        <p className="faq-a">AI generation requests require approval from a platform admin before processing begins. If your request stays in &quot;Pending&quot; status, the admin hasn&apos;t reviewed it yet. If it was rejected, the request card will show the admin&apos;s notes explaining why.</p>

        <p className="faq-q">What does the purple &quot;AI&quot; badge on a question mean?</p>
        <p className="faq-a">The purple AI badge indicates the question was generated by AI and imported from a generation request. These questions are automatically tagged &quot;ai-generated&quot; and can be filtered using the <strong>Source</strong> filter chips in the Questions tab.</p>

        <p className="faq-q">How does multiplayer scoring work?</p>
        <p className="faq-a">Each correct answer earns <strong>100 points</strong>. If the host enabled <strong>Speed Bonus</strong> when creating the room, faster correct answers earn up to <strong>50 bonus points</strong> on top of the base 100. Incorrect and unanswered questions score 0. The live scoreboard updates after each question.</p>
      </div>
    )
  },
];
