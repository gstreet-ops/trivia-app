...
export default function CommissionerGenerator({ onClose, onOpenImport, communityCategories }) {
  return (
    <div className="commissioner-generator">
      ...
      <QuestionGeneratorCore mode="commissioner" onUploadCSV={onOpenImport} communityCategories={communityCategories} />
    </div>
  );
}
